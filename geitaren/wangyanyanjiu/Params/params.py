...
# class Ceshiget:
#     log.info('解析yaml, Path:' + path_dir + '/Params/Yaml/Ceshiget.yaml')
#     params = get_parameter('Ceshiget')
#     url = []
#     data = []
#     header = []
#     for i in range(0, len(params)):
...
class Storeget:
    log.info('解析yaml, Path:' + path_dir + '/Params/Yaml/Storeget.yaml')
    params = get_parameter('Storeget')
    url = []
    data = []
    header = []
    for i in range(0, len(params)):
